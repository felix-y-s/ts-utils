...
exports.UnhandledCaseError = void 0;
/**
...
class UnhandledCaseError extends Error {
    constructor(label, value) {
        super(`[assertNever:${label}] exhaustive check 실패 - 처리되지 않은 값: ${JSON.stringify(value)}. ` +
...
exports.UnhandledCaseError = UnhandledCaseError;
